...
$tampil2=mysqli_query($konek,"select * from tabelutusan where idteknisi='$row[idteknisi]'");
...
$tampil6=mysqli_query($konek,"select sum(jumlahrating) as totalrating from tabelmasalah where idmasalah='$idmasalah'");
