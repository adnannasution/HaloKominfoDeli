...
$tampil2=mysqli_query($konek,"select count(idopd) as total from tabelmasalah where idopd='$row[idopd]'");
$datahitung=mysqli_fetch_array($tampil2);

$edit=mysqli_query($konek,"update tabelopd set jumlahkasus='$datahitung[total]' where idopd='$row[idopd]'");
