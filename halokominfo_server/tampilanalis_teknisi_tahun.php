...
$tampil2=mysqli_query($konek,"select * from tabelmasalah join tabelutusan on tabelmasalah.idmasalah=tabelutusan.idmasalah where tanggalmasalah like '%$tahun-%' and tabelutusan.idteknisi='$row[idteknisi]'");
...
$tampil6=mysqli_query($konek,"select sum(jumlahrating) as totalrating from tabelmasalah where idmasalah='$idmasalah' and tanggalmasalah like '%$tahun-%'");
