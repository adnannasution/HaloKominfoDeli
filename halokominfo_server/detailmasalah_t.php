...
//$tampil=mysqli_query($konek,"select * from tabelmasalah join tabelopd on tabelopd.idopd=tabelmasalah.idopd where idmasalah='$id'");
...
array_push($response['data'], array('idmasalah'=>$idmasalah, 'masalah'=>$masalah, 'opd'=>$opd, 'tanggalmasalah'=>$tanggalmasalah, 'waktumasalah'=>$waktumasalah, 'lama'=>$lama, 'rating'=>$rating, 'ket'=>$ket, 'status'=>$status, 'namacus'=>$namacus, 'kode'=>$kode));
