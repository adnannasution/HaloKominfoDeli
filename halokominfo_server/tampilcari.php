...
$tampil=mysqli_query($konek,"select * from tabelmasalah join tabelopd on tabelmasalah.idopd=tabelopd.idopd where masalah like '%$cari%' or kode like '%$cari%' or tanggalmasalah like '%$cari%' or tabelopd.opd like '%$cari%'  order by idmasalah asc");
